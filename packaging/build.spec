...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'ui.recap_view',
        'ui.history_settings_views',
        'ui.game_detail_panel',
        'ui.add_game_dialog',
        'ui.mark_purchased_dialog',
        'ui.animations',
        'ui.widgets',
        'ui.image_cache',
        'ui.event_time',
        ...
        'services.steam_api',
        'services.steam_auth',
        'services.steam_wishlist',
        'services.sale_images',
        'services.steamdb_scraper',
        'services.steamgriddb',
        'services.drive_sync',
        'services.library_api',
        'services.bundle_api',
        'services.recommendation',
        'services.savings_reporter',
        'services.steamkustom_auth',
        # Data
        'data.repository',
        'data.models',
        'data.purchase_repository',
        'data.excel_manager',
    ],
    hookspath=[],
    runtime_hooks=[],
